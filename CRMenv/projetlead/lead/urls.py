...
urlpatterns = [
    ...
    #path('lead/<int:pk>/interactions/add/', views.add_interaction, name='add_interaction'),
    path('lead/<int:pk>/add-interaction/', views.add_interaction, name='add_interaction'),
